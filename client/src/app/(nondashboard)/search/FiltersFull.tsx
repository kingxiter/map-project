  ...
  return (
    <div className="bg-white rounded-lg px-4 h-full overflow-auto pb-10">
      <div className="flex flex-col space-y-6">
        {/* Location */}
        <div>
          <h4 className="font-bold mb-2">Artista</h4>
        ...
        {/* Property Type */}
        <div>
          <h4 className="font-bold mb-2">Tipo de Artista</h4>
        ...
        {/* Price Range */}
        <div>
          <h4 className="font-bold mb-2">Faixa de preço (mensal)</h4>
          <Slider
            min={0}
            max={10000}
            step={100}
        ...
        {/* Beds and Baths alterar para anos de exp */}
        <div className="flex gap-4">
          <div className="flex-1">
            <h4 className="font-bold mb-2">Anos de experiência</h4>
            <Select
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="any">Anos</SelectItem>
                <SelectItem value="1">1+ Anos</SelectItem>
                <SelectItem value="2">3+ Anos</SelectItem>
                <SelectItem value="3">5+ Anos</SelectItem>
                <SelectItem value="4">10+ Anos</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div className="flex-1">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="any">Serviços finalizados</SelectItem>
                <SelectItem value="1">2+ Serviços</SelectItem>
                <SelectItem value="2">5+ serviços</SelectItem>
                <SelectItem value="3">8+ baths</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
        ...
        {/* Available From */}
        <div>
          <h4 className="font-bold mb-2">Disponível a partir de:</h4>
          <Input
            type="date"
            value={
